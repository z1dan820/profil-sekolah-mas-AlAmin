...
<head>
	<title>MAS AL-AMIN | BANDAR MASILAM</title>
	<link rel="icon" href="asset/frontend/img/th.jpg">
	<meta charset="utf-8">
...
<body>
			...
			<div class="container">
				<div class="header__inner">
					<div class="header-logo">
						<h1 style="color : white">MAS AL-AMIN</h1>
					</div>
					...
					<div class="swiper-wrapper">
						<div class="hero__wrapper">
							<div class="hero__inner">
								<div class="container">
									<img src="asset/frontend/img/mas.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="hero__wrapper">
							<div class="hero__inner">
								<div class="container">
									<img src="asset/frontend/img/kog.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
	...
	<section class="md-section md-skin-dark" id="id6"
		style="background-image:url(&quot;asset/frontend/img/mas.jpg&quot;);padding-bottom:50px;">
...
foreach ($sql4 as $g => $guru) {
							...
							<div class="col-md-6 ">
								<form class="contact-form">
									<div>
										...
										<!-- <div class="widget-contact__item"><span class="fa fa-whatsapp"
												style="color :  #f0542c"> Wa:</span>
											<p class="widget-contact__text"><a
													href="#"><?php echo $kontak['ig'] ?></a></p>
										</div> -->
									</div><!-- End /   -->
	...
	<div class="copyright-01 md-text-center">
		<div class="container">
			<p class="copyright-01__copy">2023 &copy; Copyright MAS AL-AMIN BANDAR MASILAM. All rights Reserved.</p>
		</div>
